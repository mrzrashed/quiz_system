              ...
              <div class="wrapper">
                <div class="d-flex justify-content-between">
                  <div class="split-header">
                    <img class="img-ss mt-1 mb-1 mr-2" src="{{asset('contents')}}/images/social-icons/instagram.svg" alt="instagram">
            ...
            <div class="table-responsive">
              <table class="table table-hover table-sm">
                ...
                <tbody>
                  <tr>
                    <td class="pr-0 pl-4">
                      <img class="profile-img img-sm" src="{{asset('contents')}}/images/profile/male/image_4.png" alt="profile image">
                    </td>
                    <td class="pl-md-0">
                  ...
                  <tr>
                    <td class="pr-0 pl-4">
                      <img class="profile-img img-sm" src="{{asset('contents')}}/images/profile/male/image_3.png" alt="profile image">
                    </td>
                    <td class="pl-md-0">
                  ...
                  <tr>
                    <td class="pr-0 pl-4">
                      <img class="profile-img img-sm" src="{{asset('contents')}}/images/profile/female/image_2.png" alt="profile image">
                    </td>
                    <td class="pl-md-0">
                  ...
                  <tr>
                    <td class="pr-0 pl-4">
                      <img class="profile-img img-sm" src="{{asset('contents')}}/images/profile/male/image_10.png" alt="profile image">
                    </td>
                    <td class="pl-md-0">
                ...
                <div class="timeline-vertical dashboard-timeline">
                  ...
                  <div class="activity-log">
                    ...
                    <div class="log-details">Report has been updated <div class="grouped-images mt-2">
                        <img class="img-sm" src="{{asset('contents')}}/images/profile/male/image_4.png" alt="Profile Image" data-toggle="tooltip" title="Gerald Pierce">
                        <img class="img-sm" src="{{asset('contents')}}/images/profile/male/image_5.png" alt="Profile Image" data-toggle="tooltip" title="Edward Wilson">
                        <img class="img-sm" src="{{asset('contents')}}/images/profile/female/image_6.png" alt="Profile Image" data-toggle="tooltip" title="Billy Williams">
                        <img class="img-sm" src="{{asset('contents')}}/images/profile/male/image_6.png" alt="Profile Image" data-toggle="tooltip" title="Lelia Hampton">
